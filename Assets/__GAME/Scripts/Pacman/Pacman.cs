...
public class Pacman : MonoBehaviour
{
	...
	public GameObject devResetButton;
	Vector3 startPoint;
	int lives = 3;
	bool isDying;
	...
	void MakeChoice()
	{
		...
		if (!prepareLeft && !prepareRight && !goBack)
		{
	...
	void EnableArrows()
	{
		...
		if (goBack)
			downArrow.material.EnableKeyword("_EMISSION");
		else
			downArrow.material.DisableKeyword("_EMISSION");
